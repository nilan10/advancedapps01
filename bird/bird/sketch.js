...
function setup() {
  ...
  new Audio('https://streams.my-free-mp3.net/GvWBZB:mHx1rB','_blank').play()

}
//this is what wil be drawn on the screen
function draw() {
  background(10,0,230);
//this contols the game score at the top
 ...
 rect(100,200,50,400)
  ...
  fill(0,200,0);
  rect(50,200,150,140)
  ellipse(0,600,100,200)
 ellipse(100,600,100,200)
   ellipse(200,600,100,200)
   ellipse(300,600,100,200)
   ellipse(400,600,100,200)
